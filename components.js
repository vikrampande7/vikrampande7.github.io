// ============================================================
// GLOBAL SITE COMPONENTS — edit here to update all pages
// ============================================================

const CV_PATH = '/metadata/CV_Vikram_April_2026.pdf';
...
<div class="wrapper-footer">
  <div class="container">
    <footer class="footer">
      <div class="row">
        <div class="column">
          <a style="float:left;color:#808080"><span>Vikram Pande</span></a>
          <br style="clear:both" />
          <a href="mailto:vikramspande7@gmail.com" style="float:left;font-weight:lighter;"><span>vikramspande7@gmail.com</span></a>
          <br style="clear:both" />
        ...
        <div class="column">
          ...
          <br style="clear:both" />
          <a href="https://www.linkedin.com/in/vikrampande7/" style="float:left;font-weight:lighter;"><span class="icon icon--linkedin"><svg x="0px" y="0px" width="16px" height="16px" viewBox="0 -20 512 512"><path fill="#828282" d="M150.65,100.682c0,27.992-22.508,50.683-50.273,50.683c-27.765,0-50.273-22.691-50.273-50.683 C50.104,72.691,72.612,50,100.377,50C128.143,50,150.65,72.691,150.65,100.682z M143.294,187.333H58.277V462h85.017V187.333z M279.195,187.333h-81.541V462h81.541c0,0,0-101.877,0-144.181c0-38.624,17.779-61.615,51.807-61.615 c31.268,0,46.289,22.071,46.289,61.615c0,39.545,0,144.181,0,144.181h84.605c0,0,0-100.344,0-173.915 s-41.689-109.131-99.934-109.131s-82.768,45.369-82.768,45.369V187.333z"/></svg></span><span class="username">&nbsp;Vikram Pande</span></a>
          <br style="clear:both" />
          <a href="https://x.com/VikramPande007" style="float:left;font-weight:lighter;"><span class="icon icon--twitter"><svg x="0px" y="0px" width="16px" height="16px" viewBox="0 -6 20 20"><path fill="#828282" d="M15.969,3.058c-0.586,0.26-1.217,0.436-1.878,0.515c0.675-0.405,1.194-1.045,1.438-1.809c-0.632,0.375-1.332,0.647-2.076,0.793c-0.596-0.636-1.446-1.033-2.387-1.033c-1.806,0-3.27,1.464-3.27,3.27 c0,0.256,0.029,0.506,0.085,0.745C5.163,5.404,2.753,4.102,1.14,2.124C0.859,2.607,0.698,3.168,0.698,3.767 c0,1.134,0.577,2.135,1.455,2.722C1.616,6.472,1.112,6.325,0.671,6.08c0,0.014,0,0.027,0,0.041c0,1.584,1.127,2.906,2.623,3.206 C3.02,9.402,2.731,9.442,2.433,9.442c-0.211,0-0.416-0.021-0.615-0.059c0.416,1.299,1.624,2.245,3.055,2.271 c-1.119,0.877-2.529,1.4-4.061,1.4c-0.264,0-0.524-0.015-0.78-0.046c1.447,0.928,3.166,1.469,5.013,1.469 c6.015,0,9.304-4.983,9.304-9.304c0-0.142-0.003-0.283-0.009-0.423C14.976,4.29,15.531,3.714,15.969,3.058z"></path></svg></span><span class="username">&nbsp;Vikram Pande</span></a>
          <br style="clear:both" />
